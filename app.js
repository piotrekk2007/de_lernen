...
const DEFAULT_SETS_DATA = [
  { name: 'Dom i mieszkanie', icon: '🏠', words: [
    ...
    {en:'der Teppich',pl:'dywan'},{en:'die Waschmaschine',pl:'pralka'},
    {en:'der Geschirrspüler',pl:'zmywarka'},{en:'die Mikrowelle',pl:'mikrofalówka'},
    {en:'der Staubsauger',pl:'odkurzacz'},{en:'der Fernseher',pl:'telewizor'},
    {en:'die Steckdose',pl:'gniazdko elektryczne'},{en:'der Lichtschalter',pl:'włącznik światła'},
    {en:'die Heizung',pl:'ogrzewanie/grzejnik'},{en:'die Bettdecke',pl:'kołdra'},
    {en:'das Kissen',pl:'poduszka'},
  ]},
  { name: 'Rodzina', icon: '👨‍👩‍👧', words: [
    ...
    {en:'geschieden',pl:'rozwiedziony/rozwiedziona'},{en:'verlobt',pl:'zaręczony/zaręczona'},
    {en:'die Hochzeit',pl:'ślub/wesele'},{en:'der Partner',pl:'partner'},
    {en:'die Partnerin',pl:'partnerka'},{en:'die Beziehung',pl:'związek'},
    {en:'der Witwer',pl:'wdowiec'},{en:'die Witwe',pl:'wdowa'},
    {en:'der Stiefvater',pl:'ojczym'},{en:'die Stiefmutter',pl:'macocha'},
    {en:'der Halbbruder',pl:'brat przyrodni'},{en:'die Halbschwester',pl:'siostra przyrodnia'},
    {en:'die Scheidung',pl:'rozwód'},
  ]},
  { name: 'Podstawowe czasowniki', icon: '⚡', words: [
    ...
    {en:'müssen',pl:'musieć'},{en:'können',pl:'móc/potrafić'},{en:'wollen',pl:'chcieć'},
    {en:'warten',pl:'czekać'},{en:'treffen',pl:'spotykać'},{en:'vergessen',pl:'zapominać'},
    {en:'erinnern',pl:'przypominać'},{en:'zeigen',pl:'pokazywać'},{en:'verlassen',pl:'opuszczać'},
  ]},
  { name: 'Liczby i czas', icon: '⏰', words: [
    ...
    {en:'elf',pl:'jedenaście'},{en:'zwölf',pl:'dwanaście'},{en:'zwanzig',pl:'dwadzieścia'},
    {en:'dreißig',pl:'trzydzieści'},{en:'hundert',pl:'sto'},{en:'tausend',pl:'tysiąc'},
    ...
    {en:'Juli',pl:'lipiec'},{en:'August',pl:'sierpień'},{en:'September',pl:'wrzesień'},
    {en:'Oktober',pl:'październik'},{en:'November',pl:'listopad'},{en:'Dezember',pl:'grudzień'},
  ]},
  { name: 'Kolory i przymiotniki', icon: '🎨', words: [
    ...
    {en:'dunkel',pl:'ciemny'},{en:'hell',pl:'jasny'},{en:'laut',pl:'głośny'},
    {en:'leise',pl:'cichy'},{en:'hart',pl:'twardy'},{en:'weich',pl:'miękki'},
    {en:'trocken',pl:'suchy'},{en:'nass',pl:'mokry'},{en:'rund',pl:'okrągły'},
  ]},
  { name: 'Jedzenie i picie', icon: '🍺', words: [
    ...
    {en:'die Wurst',pl:'kiełbasa'},{en:'der Speck',pl:'boczek'},{en:'die Gurke',pl:'ogórek'},
    {en:'der Spinat',pl:'szpinak'},{en:'die Zitrone',pl:'cytryna'},
    {en:'die Weintraube',pl:'winogrono'},{en:'der Essig',pl:'ocet'},
    {en:'das Mehl',pl:'mąka'},{en:'das Frühstück',pl:'śniadanie'},
  ]},
  { name: 'Transport i miasto', icon: '🚂', words: [
    ...
    {en:'das Schwimmbad',pl:'basen'},{en:'das Theater',pl:'teatr'},
    {en:'die Post',pl:'poczta'},{en:'der Kindergarten',pl:'przedszkole'},
    {en:'der Hafen',pl:'port'},{en:'die Ampel',pl:'sygnalizacja świetlna'},
    {en:'die Autobahn',pl:'autostrada'},{en:'der Stau',pl:'korek drogowy'},
    {en:'das Stadion',pl:'stadion'},{en:'die Einbahnstraße',pl:'ulica jednokierunkowa'},
  ]},
  { name: 'Ciało i zdrowie', icon: '🏥', words: [
    ...
    {en:'das Fieber',pl:'gorączka'},{en:'der Husten',pl:'kaszel'},
    {en:'der Schnupfen',pl:'katar'},{en:'die Allergie',pl:'alergia'},
    {en:'das Pflaster',pl:'plaster'},{en:'die Tablette',pl:'tabletka'},
    {en:'die Spritze',pl:'zastrzyk'},{en:'der Krankenwagen',pl:'karetka pogotowia'},
  ]},
  { name: 'Praca i edukacja', icon: '💼', words: [
    ...
    {en:'die Besprechung',pl:'zebranie/spotkanie'},{en:'das Vorstellungsgespräch',pl:'rozmowa kwalifikacyjna'},
    {en:'der Lebenslauf',pl:'życiorys/CV'},{en:'das Praktikum',pl:'staż'},
    {en:'das Homeoffice',pl:'praca zdalna'},{en:'der Unterricht',pl:'lekcja/zajęcia'},
    {en:'die Lehrerin',pl:'nauczycielka'},{en:'die Bewerbung',pl:'podanie o pracę'},
    {en:'der Auszubildende',pl:'praktykant/uczeń zawodu'},{en:'der Direktor',pl:'dyrektor'},
  ]},
  { name: 'Zwroty codzienne', icon: '💬', words: [
    ...
    {en:'Können Sie das wiederholen?',pl:'Czy może Pan powtórzyć? / Czy może Pani powtórzyć?'},
    {en:'Sprechen Sie Polnisch?',pl:'Czy mówi Pan po polsku? / Czy mówi Pani po polsku?'},
    {en:'Ich lerne Deutsch',pl:'Uczę się niemieckiego'},
    {en:'Wie heißen Sie?',pl:'Jak Pan się nazywa? / Jak Pani się nazywa?'},
    {en:'Ich heiße...',pl:'Nazywam się...'},
    {en:'Woher kommen Sie?',pl:'Skąd Pan pochodzi? / Skąd Pani pochodzi?'},
    {en:'Ich komme aus Polen',pl:'Pochodzę z Polski'},
    {en:'Wie geht es Ihnen?',pl:'Jak się Pan miewa? / Jak się Pani miewa?'},
    ...
    {en:'Sehr gut!',pl:'Bardzo dobrze!'},{en:'Kein Problem',pl:'Żaden problem'},
    {en:'Alles klar',pl:'Wszystko jasne'},{en:'Wie bitte?',pl:'Słucham?/Proszę?'},
    {en:'Ich weiß nicht',pl:'Nie wiem'},{en:'Leider nicht',pl:'Niestety nie'},
    {en:'Gern geschehen',pl:'Nie ma za co/Chętnie'},{en:'Auf Wiederhören',pl:'Do usłyszenia'},
    {en:'Wie alt sind Sie?',pl:'Ile Pan ma lat? / Ile Pani ma lat?'},
    {en:'Wo wohnen Sie?',pl:'Gdzie Pan mieszka? / Gdzie Pani mieszka?'},
    {en:'Was machen Sie beruflich?',pl:'Czym Pan się zajmuje? / Czym Pani się zajmuje?'},
    {en:'Mit freundlichen Grüßen',pl:'Z poważaniem'},{en:'Wann?',pl:'Kiedy?'},
  ]},
  { name: 'Niemcy — kultura i realia', icon: '🇩🇪', words: [
    {en:'Deutschland',pl:'Niemcy'},{en:'Berlin',pl:'Berlin (stolica)'},{en:'Bayern',pl:'Bawaria'},
    {en:'Hamburg',pl:'Hamburg'},{en:'München',pl:'Monachium'},
    ...
    {en:'das Grundgesetz',pl:'ustawa zasadnicza/konstytucja'},
    ...
    {en:'der Personalausweis',pl:'dowód osobisty'},
    {en:'die Steuern',pl:'podatki'},{en:'die Miete',pl:'czynsz'},
    {en:'die Nebenkosten',pl:'koszty dodatkowe'},{en:'die Müllabfuhr',pl:'wywóz śmieci'},
    {en:'die Ruhezeit',pl:'cisza nocna'},{en:'das Pfand',pl:'kaucja za butelki'},
    {en:'pünktlich',pl:'punktualny'},{en:'gemütlich',pl:'przytulny/wygodny'},
    {en:'gründlich',pl:'dokładny/gruntowny'},{en:'ordentlich',pl:'porządny/schludny'},
    {en:'die Mehrwertsteuer',pl:'podatek VAT'},{en:'der TÜV',pl:'przegląd techniczny'},
    {en:'die Sozialversicherung',pl:'ubezpieczenie społeczne'},
    {en:'das Einwohnermeldeamt',pl:'urząd meldunkowy'},
    {en:'die Krankmeldung',pl:'zwolnienie lekarskie'},
    {en:'das Kindergeld',pl:'zasiłek na dziecko'},
  ...
  { name: 'Emocje i charakter', icon: '😊', words: [
    ...
    {en:'aufgeregt',pl:'podekscytowany/podniecony'},{en:'entspannt',pl:'odprężony/zrelaksowany'},
    {en:'gestresst',pl:'zestresowany'},{en:'zufrieden',pl:'zadowolony'},
    {en:'unzufrieden',pl:'niezadowolony'},{en:'einsam',pl:'samotny'},
    {en:'verliebt',pl:'zakochany'},{en:'tapfer',pl:'dzielny/odważny'},
    {en:'empfindlich',pl:'wrażliwy/czuły'},{en:'sensibel',pl:'delikatny/czuły'},
  ]},
];
